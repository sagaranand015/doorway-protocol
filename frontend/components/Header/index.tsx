              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                {
                  currentAccount ? (
                    <>
                      <h4 onClick={disconnectWalletHandler} className="cursor-pointer"><b>{shortenAddress(currentAccount)}</b>
                      </h4>
                    </>) :
                    (<>
                      <Link
                        href='#' onClick={setCurrentAccount}
